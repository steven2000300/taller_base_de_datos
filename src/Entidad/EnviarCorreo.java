...
public class EnviarCorreo {
    ...
    public void enviar(String parametros[]){
     ...
     public void test1(){ // enviar correo a un solo destinatario
         String parametros[] =  { "Jhon Edward Steven Loaiza Diaz",      // remitente
                                "steven2000300@gmail.com",     // correoRemitente
                                "epwy ifux jxba hoax",                 // contrasena de aplicaciones de Gmail
                                "jhon.loaiza01@uceva.edu.co",              // correoDestinatario
     ...
     public void test3(){ // enviar correo a varios destinatarios con archivos adjuntos
         ...
         String correosDestinatarios[] = {"jhon.loaiza01@uceva.edu.co",
                                          "sebastian.morales01@uceva.edu.co",
                                          "llasso@uceva.edu.co",
                                          "adrianlassocardona@yahoo.es"
         };

         String archivos[] = {"clientes.csv"};
